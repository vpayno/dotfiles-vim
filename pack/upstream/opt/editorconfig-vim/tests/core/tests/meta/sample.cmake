...
run_and_sort(
  ...
  did_fail
  CAPTURE_STDERR
  TRIM_INITIAL_LEADING_SPACE # since we're using almostcat
  CMDLINE
  "cmake"
  "-DWHICH:STRING=${tests_meta_sample_dir}/sample.txt"
  "-P"
  "${tests_meta_sample_dir}/../cmake/almostcat.cmake") # Don't use cat(1) since
...
# You could also use execute_process( COMMAND "echo" "${lines}" ) or cmake -E
# echo, but I think the message() call is good enough.
