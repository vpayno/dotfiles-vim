...
let _enable_ale_arduino_fixers    = g:enable
let _enable_ale_arduino_linters   = g:enable
...
let _enable_css                   = g:disable " controls all of the css_ options
let _enable_css_color             = g:enable
let _enable_css_less              = g:enable
let _enable_cue                   = g:enable
let _enable_cue_fmt               = g:enable
...
let _enable_keys_mine             = g:disable
...
let _enable_rust_rustvim          = g:disable
...
let _enable_undotree              = g:disable
let _enable_undotree_persist      = g:disable
...
let _enable_xml                   = g:enable
let _enable_xml_fmt               = g:enable
